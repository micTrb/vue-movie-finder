...
describe('Stack', () => {
  ...
  it('Should have an isEmpty function that retrieves true if the Stack is empty and false otherwise', () => {
    expect(stack.isEmpty()).toBe(true);
    stack.items.push(2)
    expect(stack.isEmpty()).toBe(false);
  })

  it('Should have an isFull function that returns true if the Stack has reached the given capacity and false otherwise', () => {
  ...
  describe('Push', () => {
    ...
    it('Should return Full if the stack has reached the capacity', () => {
      stack.items = [1, 2, 3];
    ...
    it('Should return the new pushed element at the top of the stack', () => {
